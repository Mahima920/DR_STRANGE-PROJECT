...
with mp_holistic.Holistic(
    ...
    if use_virtual_cam:
        ...
        print("⌨️  Press 'q' to quit" +
              (" (in OpenCV window)" if show_window else "") +
              " or Ctrl+C\n")
        print("=" * 60 + "\n")
    ...
    try:
        ...
        while cap.isOpened():
            ...
            print(
                f"\r{status_shields} | {status_k1} {status_k2} {status_k3}",
                end="",
                flush=True
            )
            ...
            if not ret_shield:
                shield = cv2.VideoCapture(
                    current_directory + '/' + args.shield_video
                )
            ...
            xMinL, xMaxL, yMinL, yMaxL = get_center_lh(
                frame,
                results
            )

            xMinR, xMaxR, yMinR, yMaxR = get_center_rh(
                frame,
                results
            )
            ...
            if xMinL and xMinR and SHIELDS:
                ...
                prediction = model.predict(
                    np.array([
                        points_detection_hands(results)
                    ])
                )[0]
            ...
            # ==================================================
            # GESTURE DETECTION - KEY 1, KEY 2, KEY 3
            # ==================================================
            ...
            if show_window and cv2.waitKey(1) & 0xFF == ord('q'):
                ...
                # Se non c'è finestra, usa un piccolo delay
                time.sleep(0.033)  # ~30 FPS

    except KeyboardInterrupt:

        # Gestione alternativa del Ctrl+C
        print(
